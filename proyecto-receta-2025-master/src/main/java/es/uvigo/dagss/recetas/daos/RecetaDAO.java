...
public interface RecetaDAO extends JpaRepository<Receta, Long>,JpaSpecificationExecutor<Receta> {
    ...
    // (HU-P4) ver recetas 
    List<Receta> findByPrescripcionPacienteIdOrderByFechaValidezInicioDesc(Long idPaciente);
}